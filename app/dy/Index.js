...
const Index = {
    ...
    inRecommend() {
        let tag = Common.id(V.Index.inRecommend[0]).text(V.Index.inRecommend[1]).isVisibleToUser(true).findOneBy(1000);
        if (tag && tag.parent() && tag.parent().desc() && tag.parent().desc().indexOf(V.Index.inRecommend[2]) != -1) {
            return true;
        }
        return false;
    }
